...
import { fadeUp, stagger, t } from '../lib/animations';
          ...
          <div className="relative z-10">
            ...
            <motion.div variants={fadeUp} transition={t()} className="flex max-sm:flex-col gap-3.5 mb-15">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-[15px] rounded-full text-sm font-medium bg-ink text-bone border border-ink transition-all hover:-translate-y-px hover:shadow-card"
              >
                Explore Services <span className="transition-transform">→</span>
              </button>
              <button
